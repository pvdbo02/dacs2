	...
	class category
	{
		...
		public function insert_category($catName){
			...
			if(empty($catName)){
				...
				if($result){
					$alert = "<span class='success'>Danh mục thêm thành công </span>";
					return $alert;
				}else {
					$alert = "<span class='error'Danh mục thêm không thành công</span>";
					return $alert;
				}
			}
		}
		...
		public function update_category($catName,$id)
		{
			...
			if(empty($catName)){
				...
				if($result){
					...
					$alert = "<span class='error'>Danh mục cập nhật không thành công</span>";
					return $alert;
				}
			}
		...
		public function del_category($id)
		{
			...
			if($result){
				...
				$alert = "<span class='success'>Danh mục thêm không thành công</span>";
				return $alert;
			}
		}
