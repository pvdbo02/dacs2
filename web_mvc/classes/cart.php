...
<?php 
	...
	*/
	class cart
	{
		...
		public function add_to_cart($id,$size, $quantity)
		{
			...
			if($result['product_remain']>$quantity){
				...
				$query_insert = "INSERT INTO tbl_cart(productId,productName,size,quantity,sId,price,image) VALUES('$id','$productName','$size','$quantity','$sId','$price','$image' ) ";
		...
		public function insertOrder($customer_id)
		{
			...
			if($get_product){
				while($result = $get_product->fetch_assoc()){
					...
					$query_order = "INSERT INTO tbl_order(productId,productName,size,quantity,price,image,customer_id) VALUES('$productid','$productName','$size','$quantity','$price','$image','$customer_id')";
		...
		public function shifted($id,$proid,$qty,$time,$price)
		{
			...
			if ($result) {
				...
				$msg = "<span class='erorr'> Cập nhật thất bại</span> ";
				return $msg;
			}
		}
